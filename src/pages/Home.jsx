...
const Home = () => {
  ...
  return (
    <div className="p-4 relative pt-13 md:pt-20 overflow-hidden">
      <Header />
      {/* MLH Trust Badge */}
      <a id="mlh-trust-badge" style={{ display: 'block', maxWidth: '100px', minWidth: '60px', position: 'fixed', right: '50px', top: '121px', width: '10%', zIndex: '10000' }}
